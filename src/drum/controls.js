...
const Controls = ({power, setPower, volume, setVolume, setText}) => {

  const handelpower = () => {
    setPower(!power);
    setText(power? 'OFF' : 'ON');
  }
  ...
  return(
     <div className="controls">
       <div className="checkbox-wrapper-25">
         <input type="checkbox" onClick={handelpower}/>
       </div>
       <label className="slider">
         <input type="range" value={volume} className="level" onChange={handelVolume}/>
         <svg
           className="volume"
